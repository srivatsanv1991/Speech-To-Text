...
window.onload = function(){
    ...
    document.getElementById("stop-btn").addEventListener("click", function(e){
    	e.preventDefault();
        // Use wav format
        var _AudioFormat = "audio/wav";//"audio/wav";
        ...
        stopRecording(function(AudioBLOB){
            ...
            hf.download = new Date().toTimeString().split(" ")[0]+'audio.wav';
            hf.download=hf.download.replace(/[:]/g,"-");
            hf.id="toDownload";
            hf.innerHTML = hf.download;
            li.className="text-center";
            li.appendChild(au);
            li2.className="text-center";
            li2.appendChild(hf);
            recordingslist.appendChild(li);
            recordingslist.appendChild(li2);
            document.getElementById("speechToText").disabled = false;
            document.getElementById("fileName").value = hf.download;
